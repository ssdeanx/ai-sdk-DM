...
export const domainPersonas: Record<string, PersonaDefinition> = {
  healthcareAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for healthcare information and medical topics. IMPORTANT: Not a substitute for professional medical advice.',
  ...
  legalInformationAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for general legal information and concepts. IMPORTANT: Not a substitute for professional legal advice.',
    systemPromptTemplate:
  ...
  educationAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for educational content and teaching support.',
    systemPromptTemplate:
    ...
    capabilities: [
      GeminiCapability.EXPLANATION,
      GeminiCapability.CONTENT_GENERATION,
      GeminiCapability.EDUCATIONAL_TUTORING,
    ],
    version: '1.0.0',
  }),
  ...
  financialInformationAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for financial information and concepts. IMPORTANT: Not a substitute for professional financial advice.',
    systemPromptTemplate:
    ...
    capabilities: [
      GeminiCapability.RESEARCH,
      GeminiCapability.EXPLANATION,
      GeminiCapability.FINANCIAL_ANALYSIS,
    ],
    version: '1.0.0',
  }),
  ...
  uxUiDesignerAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for user experience and interface design principles and feedback.',
    systemPromptTemplate:
    ...
    capabilities: [
      ...
      GeminiCapability.VISUALIZATION,
      GeminiCapability.EXPLANATION,
    ],
    version: '1.0.0',
  }),
  ...
  productManagerAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for product management strategies, planning, and market analysis.',
    systemPromptTemplate:
    ...
    capabilities: [
      GeminiCapability.PROJECT_MANAGEMENT,
      GeminiCapability.ANALYSIS,
      GeminiCapability.TECHNICAL_PLANNING,
...
export const taskPersonas: Record<string, PersonaDefinition> = {
  interviewCoach: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for interview preparation, practice, and feedback.',
    systemPromptTemplate:
  ...
  studyBuddy: validatePersonaDefinition({
    ...
    name: 'Study Buddy',
    description:
      'A specialized assistant for study help, concept explanation, and academic support.',
    systemPromptTemplate:
  ...
  travelPlanner: validatePersonaDefinition({
    ...
    name: 'Travel Planner',
    description:
      'A specialized assistant for travel planning, destination research, and itinerary suggestions.',
    systemPromptTemplate:
  ...
  fitnessInformationAssistant: validatePersonaDefinition({
    ...
    description:
      'A specialized assistant for fitness information and workout guidance. IMPORTANT: Not a substitute for professional fitness advice.',
    systemPromptTemplate:
  ...
  languageTutor: validatePersonaDefinition({
    ...
    name: 'Language Tutor',
    description:
      'A specialized assistant for language learning, grammar explanation, and conversation practice.',
    systemPromptTemplate:
    ...
    capabilities: [
      ...
      GeminiCapability.TEXT_GENERATION,
      GeminiCapability.EXPLANATION,
      GeminiCapability.MULTIMODAL_UNDERSTANDING,
    ],
    version: '1.0.0',
  }),
};
 ...
 */
async function registerPersonaWithManager(
 ...
 */
export async function registerDomainPersonas(): Promise<
...
> {
  ...
  for (const [key, persona] of Object.entries(domainPersonas)) {
    try {
      ...
      console.error(
        `Error registering domain persona ${key}:`,
...
export async function registerTaskPersonas(): Promise<Record<string, string>> {
  ...
  for (const [key, persona] of Object.entries(taskPersonas)) {
    try {
      ...
      console.error(
        `Error registering task persona ${key}:`,
        error instanceof Error ? error.message : error
      );
    }
  }
