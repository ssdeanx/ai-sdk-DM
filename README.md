...
```mermaidgraph TD
    ...
    64509["User<br>External Actor"]
    subgraph 64494["External Systems & Services"]
        64560["Supabase Platform<br>BaaS (Auth, DB, Realtime)"]
        64561["Upstash Platform<br>Serverless Data (Redis, QStash, Vector)"]
        64562["Langfuse Platform<br>LLM Observability"]
        64563["OpenAI API<br>LLM Provider"]
        64564["Anthropic API<br>LLM Provider"]
        64565["Google AI / Vertex API<br>LLM Provider"]
        64566["GitHub Platform<br>OAuth, SCM"]
        64567["Third-Party Tool APIs<br>External Services (Tavily, Wikipedia, etc.)"]
    end
    subgraph 64495["AI SDK Development & Management Platform"]
        64510["Shared Platform Types<br>TypeScript"]
        subgraph 64496["Build & Development Configuration"]
            64558["Tailwind CSS Configuration<br>TailwindCSS"]
            64559["ESLint Configuration<br>ESLint"]
        end
        subgraph 64497["Database System"]
            subgraph 64498["Supabase PostgreSQL Database Store"]
                64555["Supabase Schema Definitions<br>Drizzle ORM"]
                64556["Supabase Drizzle ORM Config<br>TypeScript"]
                64557["Supabase Server-Side Utilities<br>TypeScript"]
            end
            subgraph 64499["LibSQL Database Store"]
                64553["LibSQL Schema Definitions<br>Drizzle ORM"]
                64554["LibSQL Drizzle ORM Config<br>TypeScript"]
            end
        end
        subgraph 64500["Core AI SDK Library"]
            64550["Middleware Framework<br>TypeScript"]
            64551["Model Registry &amp; Service<br>TypeScript"]
            64552["SDK Shared Utilities<br>TypeScript"]
            subgraph 64501["Tracing & Observability Services"]
                64547["Langfuse Integration Client<br>TypeScript"]
                64548["OpenTelemetry Integration Client<br>TypeScript"]
                64549["AI SDK Tracing Facade<br>TypeScript"]
            end
            subgraph 64502["Workflow System Library"]
                64543["Workflow Provider Facade<br>TypeScript"]
                64544["LibSQL Workflow Adapter<br>TypeScript"]
                64545["Upstash Workflow Adapter<br>TypeScript"]
                64546["Supabase Workflow Adapter<br>TypeScript"]
            end
            subgraph 64503["Agent System Library"]
                64539["Agent Service Logic<br>TypeScript"]
                64540["Base Agent Implementation<br>TypeScript"]
                64541["Agent Registry Logic<br>TypeScript"]
                64542["Multi-Agent Orchestrator<br>TypeScript"]
            end
            subgraph 64504["Memory Management System"]
                64534["Memory Provider Factory<br>TypeScript"]
                64535["LibSQL Memory Store Adapter<br>TypeScript"]
                64536["Supabase Memory Store Adapter<br>TypeScript"]
                64537["Upstash Memory Store Adapter<br>TypeScript"]
                64538["Core Memory Logic &amp; Utilities<br>TypeScript"]
            end
            subgraph 64505["Tooling System & Execution"]
                64530["Tool Registry &amp; Management<br>TypeScript"]
                64531["Built-in Tools Collection<br>TypeScript"]
                64532["Agentic Tools Collection<br>TypeScript"]
                64533["Tool Execution Store Adapter<br>TypeScript"]
            end
            subgraph 64506["AI Model Integration Services"]
                64525["Generic AI Provider Facade<br>TypeScript"]
                64526["OpenAI Adapter<br>TypeScript"]
                64527["Anthropic Adapter<br>TypeScript"]
                64528["Google AI Adapter<br>TypeScript"]
                64529["Vertex AI Adapter<br>TypeScript"]
            end
        end
        subgraph 64507["Backend API Service"]
            64515["API Gateway<br>Next.js API Routes"]
            64516["Tool Endpoints<br>Next.js API Routes"]
            64517["Agent Endpoints<br>Next.js API Routes"]
            64518["Chat Endpoints<br>Next.js API Routes"]
            64519["Model Endpoints<br>Next.js API Routes"]
            64520["Thread &amp; Memory Endpoints<br>Next.js API Routes"]
            64521["Workflow Endpoints<br>Next.js API Routes"]
            64522["Authentication Endpoints<br>Next.js API Routes"]
            64523["System &amp; Status Endpoints<br>Next.js API Routes"]
            64524["Generic Entity CRUD Endpoints<br>Next.js API Routes"]
            %% Edges at this level (grouped by source)
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64520["Thread &amp; Memory Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64517["Agent Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64519["Model Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64522["Authentication Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64523["System &amp; Status Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64524["Generic Entity CRUD Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64516["Tool Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64521["Workflow Endpoints<br>Next.js API Routes"]
            64515["API Gateway<br>Next.js API Routes"] -->|routes to| 64518["Chat Endpoints<br>Next.js API Routes"]
        end
        subgraph 64508["Frontend Web Application"]
            64511["Application Pages &amp; Layouts<br>Next.js, React"]
            64512["UI Framework &amp; Components<br>React, Shadcn/UI"]
            64513["Feature-Specific Components<br>React"]
            64514["Client-Side Hooks<br>React Hooks, TypeScript"]
        end
    end
    %% Edges at this level (grouped by source)
    64509["User<br>External Actor"] -->|interacts with| 64511["Application Pages &amp; Layouts<br>Next.js, React"]
    64514["Client-Side Hooks<br>React Hooks, TypeScript"] -->|communicates with| 64560["Supabase Platform<br>BaaS (Auth, DB, Realtime)"]
    64522["Authentication Endpoints<br>Next.js API Routes"] -->|authenticates via| 64560["Supabase Platform<br>BaaS (Auth, DB, Realtime)"]
    64522["Authentication Endpoints<br>Next.js API Routes"] -->|uses| 64566["GitHub Platform<br>OAuth, SCM"]
    64523["System &amp; Status Endpoints<br>Next.js API Routes"] -->|checks status of| 64561["Upstash Platform<br>Serverless Data (Redis, QStash, Vector)"]
    64525["Generic AI Provider Facade<br>TypeScript"] -->|calls| 64563["OpenAI API<br>LLM Provider"]
    64525["Generic AI Provider Facade<br>TypeScript"] -->|calls| 64564["Anthropic API<br>LLM Provider"]
    64525["Generic AI Provider Facade<br>TypeScript"] -->|calls| 64565["Google AI / Vertex API<br>LLM Provider"]
    64526["OpenAI Adapter<br>TypeScript"] -->|calls| 64563["OpenAI API<br>LLM Provider"]
    64527["Anthropic Adapter<br>TypeScript"] -->|calls| 64564["Anthropic API<br>LLM Provider"]
    64528["Google AI Adapter<br>TypeScript"] -->|calls| 64565["Google AI / Vertex API<br>LLM Provider"]
    64529["Vertex AI Adapter<br>TypeScript"] -->|calls| 64565["Google AI / Vertex API<br>LLM Provider"]
    64537["Upstash Memory Store Adapter<br>TypeScript"] -->|accesses| 64561["Upstash Platform<br>Serverless Data (Redis, QStash, Vector)"]
    64545["Upstash Workflow Adapter<br>TypeScript"] -->|accesses| 64561["Upstash Platform<br>Serverless Data (Redis, QStash, Vector)"]
    64548["OpenTelemetry Integration Client<br>TypeScript"] -->|sends data to| 64561["Upstash Platform<br>Serverless Data (Redis, QStash, Vector)"]
    64533["Tool Execution Store Adapter<br>TypeScript"] -->|uses| 64561["Upstash Platform<br>Serverless Data (Redis, QStash, Vector)"]
    64532["Agentic Tools Collection<br>TypeScript"] -->|calls| 64567["Third-Party Tool APIs<br>External Services (Tavily, Wikipedia, etc.)"]
