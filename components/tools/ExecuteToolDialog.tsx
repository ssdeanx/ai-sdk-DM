...
export function EnhancedToolCard({
  ...
  try {
    ...
    parametersCount = schema.properties
  ...
  return (
    <>
      ...
      >
        <Card
          className={`overflow-hidden h-full flex flex-col ${!tool.is_enabled ? 'opacity-70' : ''}`}
        >
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Badge
                            variant="outline"
                            className="bg-gray-500/10 text-gray-500 ml-2"
                          >
                            Disabled
                          </Badge>
                        </TooltipTrigger>
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    This tool can be used by agents or directly through the API.
                  </p>
                  <div className="mt-2">
                    <h4 className="font-medium">API Endpoint</h4>
                    <code className="bg-muted p-2 rounded-md text-sm block">
