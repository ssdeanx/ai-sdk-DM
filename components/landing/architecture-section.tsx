...
export default function ArchitectureSection() {
  const [architectureData, setArchitectureData] = useState({
    ...
    description:
      'The AI SDK Framework provides a modular architecture that makes it easy to build, deploy, and scale AI applications.',
    components: [
      {
        title: 'AI Models',
        description:
          'Connect to OpenAI, Google, Anthropic, and other AI providers.',
        icon: 'Layers',
      },
      {
        title: 'Agents',
        description:
          'Create specialized AI agents with different capabilities.',
        icon: 'Bot',
      },
      {
        title: 'Tools',
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-500 mb-8">{architectureData.description}</p>
          ...
          >
              ...
              <div className="relative aspect-square">
                ...
                <div className="absolute top-[25%] left-[75%] transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-green-500/20 rounded-full flex items-center justify-center border border-green-500/50 z-20">
                  <div className="text-center">
                    ...
                    <div className="text-xs font-medium text-green-300 mt-1">
                      Tools
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute top-[75%] left-[75%] transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center border border-red-500/50 z-20">
                  <div className="text-center">
                    ...
                    <div className="text-xs font-medium text-red-300 mt-1">
                      Reasoning
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute top-[50%] left-[87.5%] transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-pink-500/20 rounded-full flex items-center justify-center border border-pink-500/50 z-20">
                  <div className="text-center">
                    ...
                    <div className="text-xs font-medium text-pink-300 mt-1">
                      Chat UI
                    </div>
                  </div>
                </div>
            ...
            <div
              className="absolute top-3/4 left-1/4 w-2 h-2 bg-purple-400 rounded-full animate-pulse"
              style={{ animationDelay: '1s' }}
            ></div>
            <div
              className="absolute top-1/2 right-1/3 w-2 h-2 bg-green-400 rounded-full animate-pulse"
