...
export function SystemHealth({ metrics, isLoading }: SystemHealthProps) {
  ...
  useEffect(() => {
    ...
    g.selectAll('.tick-text')
      ...
      .attr(
        'x',
        (d: any) => radius * 1.05 * Math.cos(valueScale(d) - Math.PI / 2)
      )
      .attr(
        'y',
        (d: any) => radius * 1.05 * Math.sin(valueScale(d) - Math.PI / 2)
      )
      .attr('text-anchor', 'middle')
      .attr('dy', '0.35em')
      .attr('class', 'text-xs')
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    {getStatusBadge(
                      getHealthStatus(
                        'avgMemoryUsage',
                        metrics.summary.avgMemoryUsage
                      )
                    )}
                  </div>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    {getStatusBadge(
                      getHealthStatus(
                        'avgResponseTime',
                        metrics.summary.avgResponseTime
                      )
                    )}
                  </div>
                </CardHeader>
              ...
              <Card className="overflow-hidden border-opacity-40 backdrop-blur-sm">
                ...
                <CardContent>
                  ...
                  <div className="text-sm text-muted-foreground">
                    Peak: {metrics.summary.peakApiRequests}/min
                  </div>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <Card className="overflow-hidden border-opacity-40 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="text-3xl font-bold">
                    {metrics.summary.avgActiveUsers}
                  </div>
                  <div className="text-sm text-muted-foreground mt-1">
