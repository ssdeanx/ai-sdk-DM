...
app/api/ai-sdk/agents/personas/scores/feedback/route.ts
app/api/ai-sdk/agents/personas/scores/most-used/route.ts
app/api/ai-sdk/agents/personas/scores/recommend/route.ts
app/api/ai-sdk/agents/personas/scores/route.ts
app/api/ai-sdk/agents/personas/scores/top/route.ts
...
app/api/ai-sdk/content/architecture/route.ts
app/api/ai-sdk/content/code-examples/route.ts
app/api/ai-sdk/content/cta/route.ts
app/api/ai-sdk/content/features/route.ts
app/api/ai-sdk/content/footer/route.ts
app/api/ai-sdk/content/hero/route.ts
...
app/api/ai-sdk/networks/[id]/agents/[agentId]/route.ts
app/api/ai-sdk/networks/[id]/agents/route.ts
app/api/ai-sdk/networks/[id]/route.ts
app/api/ai-sdk/networks/route.ts
...
app/api/ai-sdk/workflows/[id]/execute/route.ts
app/api/ai-sdk/workflows/[id]/pause/route.ts
app/api/ai-sdk/workflows/[id]/resume/route.ts
app/api/ai-sdk/workflows/[id]/route.ts
app/api/ai-sdk/workflows/[id]/steps/route.ts
app/api/ai-sdk/workflows/route.ts
```

# Files

## File: app/api/ai-sdk/content/architecture/route.ts
```typescript
...
## File: app/api/ai-sdk/content/code-examples/route.ts
```typescript
import { NextResponse } from 'next/server';
import { getData } from '@/lib/memory/supabase';
export async function GET()
...
## File: app/api/ai-sdk/content/cta/route.ts
```typescript
import { NextResponse } from 'next/server';
import { getData } from '@/lib/memory/supabase';
export async function GET()
...
## File: app/api/ai-sdk/content/features/route.ts
```typescript
import { NextResponse } from 'next/server';
import { getData } from '@/lib/memory/supabase';
export async function GET()
...
## File: app/api/ai-sdk/content/footer/route.ts
```typescript
import { NextResponse } from 'next/server';
import { getData } from '@/lib/memory/supabase';
export async function GET()
...
## File: app/api/ai-sdk/content/hero/route.ts
```typescript
import { NextResponse } from 'next/server';
...
## File: app/api/ai-sdk/networks/[id]/agents/route.ts
```typescript
import { NextResponse } from 'next/server';
import { createSupabaseClient } from '@/lib/memory/upstash/supabase-adapter-factory';
import { upstashLogger } from '@/lib/memory/upstash/upstash-logger';
...
## File: app/api/ai-sdk/networks/[id]/route.ts
```typescript
import { NextResponse } from 'next/server';
import { createSupabaseClient } from '@/lib/memory/upstash/supabase-adapter-factory';
import { upstashLogger } from '@/lib/memory/upstash/upstash-logger';
...
## File: app/api/ai-sdk/workflows/[id]/execute/route.ts
```typescript
...
## File: app/api/ai-sdk/workflows/[id]/pause/route.ts
```typescript
import { NextRequest, NextResponse } from 'next/server';
import { workflow } from '@/lib/workflow';
...
## File: app/api/ai-sdk/workflows/[id]/resume/route.ts
```typescript
import { NextRequest, NextResponse } from 'next/server';
import { workflow } from '@/lib/workflow';
...
## File: app/api/ai-sdk/workflows/[id]/route.ts
```typescript
import { NextRequest, NextResponse } from 'next/server';
import { workflow } from '@/lib/workflow';
import { z } from 'zod';
...
## File: app/api/ai-sdk/workflows/[id]/steps/route.ts
```typescript
import { NextRequest, NextResponse } from 'next/server';
import { workflow } from '@/lib/workflow';
import { z } from 'zod';
...
## File: app/api/ai-sdk/workflows/route.ts
```typescript
import { NextRequest, NextResponse } from 'next/server';
import { workflow } from '@/lib/workflow';
import { z } from 'zod';
...
## File: app/api/ai-sdk/networks/[id]/agents/[agentId]/route.ts
```typescript
import { NextResponse } from 'next/server';
import { createSupabaseClient } from '@/lib/memory/upstash/supabase-adapter-factory';
import { upstashLogger } from '@/lib/memory/upstash/upstash-logger';
...
## File: app/api/ai-sdk/networks/route.ts
```typescript
import { NextResponse } from 'next/server';
import { createSupabaseClient } from '@/lib/memory/upstash/supabase-adapter-factory';
import { upstashLogger } from '@/lib/memory/upstash/upstash-logger';
...
## File: app/api/ai-sdk/agents/personas/scores/feedback/route.ts
```typescript
/**
...
## File: app/api/ai-sdk/agents/personas/scores/most-used/route.ts
```typescript
/**
...
## File: app/api/ai-sdk/agents/personas/scores/recommend/route.ts
```typescript
/**
...
## File: app/api/ai-sdk/agents/personas/scores/route.ts
```typescript
/**
...
## File: app/api/ai-sdk/agents/personas/scores/top/route.ts
```typescript
/**
