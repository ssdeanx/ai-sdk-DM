    ...
    const updatePreview = async () => {
      if (watchContent) {
        try {
          ...
          setPreviewError(
            'Error rendering preview. Your markdown might contain syntax errors.'
          );
        }
      }
    };
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description:
          'There was a problem saving your document. Please try again.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
    ...
    <div className="container py-6 space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Create and edit MDX documents with live preview
        </p>
      </div>
      ...
      <Card className="mt-8">
        <CardHeader>
          ...
          <CardDescription>
            Some helpful tips for writing MDX documents
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Use # for headings, * for italic, ** for bold, - for lists, and
              [text](url) for links.
            </p>
          </div>
          <div>
