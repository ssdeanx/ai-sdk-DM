...
const milestones = [
  {
    ...
    description:
      'Our journey began with a vision to make AI accessible to developers everywhere.',
  },
  {
    year: '2021',
    title: 'First Product Launch',
    description:
      'Released our first AI SDK with support for basic agent capabilities.',
  },
  {
    year: '2022',
    title: 'Series A Funding',
    description:
      'Raised $12M to accelerate product development and expand our team.',
  },
  {
    year: '2023',
    title: 'Agentic Toolkit Release',
    description:
      'Launched our comprehensive toolkit for building advanced AI agents.',
  },
  {
    year: '2024',
    title: 'Global Expansion',
    description:
      'Opened offices in London and Singapore to serve our growing international customer base.',
  },
];
      ...
      <section className="space-y-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            We're building the future of AI development by empowering developers
            to create intelligent, autonomous agents that can solve complex
            problems.
          </p>
        </motion.div>
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              We envision a world where AI agents seamlessly assist humans in
              solving complex problems, automating routine tasks, and unlocking
              new possibilities for creativity and innovation.
            </p>
            <p className="text-muted-foreground">
              By providing developers with powerful, flexible tools, we aim to
              democratize access to advanced AI capabilities and foster a
              thriving ecosystem of intelligent applications.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We believe in the power of collaboration, both within our
                    team and with our community.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We are committed to transparency in our processes,
