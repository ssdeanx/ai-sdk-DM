    ...
    <div className="container py-12 space-y-16">
      ...
      <div className="bg-gradient-to-r from-blue-500/10 to-violet-500/10 rounded-xl p-8 md:p-12">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          >
            Our enterprise plan is tailored to your organization's specific
            needs. Contact our sales team to learn more.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
                ...
                {feature.name === 'Premium Models' && (
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-[200px]">
                          Access to advanced models from OpenAI, Google, and
                          Anthropic
                        </p>
                      </TooltipContent>
                    </Tooltip>
