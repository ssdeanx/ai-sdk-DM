...
export default function VisualizationExamplePage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-8">Data Visualization with Tracing Example</h1>
      ...
      <div className="mt-8 p-6 bg-muted/30 rounded-lg">
        ...
        <p className="mb-4">
          This example demonstrates the integration of data visualization with Langfuse tracing.
          The visualization component creates traces for all user interactions and rendering events,
          allowing you to monitor performance and debug issues.
        </p>
        <p className="mb-4">
          Key features:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>Event logging for user interactions (changing chart type, copying data, etc.)</li>
          <li>Real-time visualization of tracing data</li>
          <li>Integration with Langfuse for advanced analytics</li>
        </ul>
        <p>
          Switch between the "Chart" and "Tracing" tabs to see both the visualization and its
          corresponding tracing data. Try changing the chart type or data set to see how the
          tracing updates in real-time.
        </p>
      </div>
    </div>
  )
