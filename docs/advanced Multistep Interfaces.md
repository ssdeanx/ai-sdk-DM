...
[Advanced](https://ai-sdk.dev/docs/advanced)Multistep Interfaces
...
**Tool composition** is the process of combining multiple [tools](https://ai-sdk.dev/docs/ai-sdk-core/tools-and-tool-calling) to create a new tool. This is a powerful concept that allows you to break down complex tasks into smaller, more manageable steps.
